...
|P5: 构建 makemore 第四部分：成为反向传播高手| 2026.7.16~|- 多分支节点的梯度=多分支的梯度的和(多元复合函数的全微分（链式法则）)<br/>- **pytorch张量中每个元素都有一个梯度值以及学习率缩放不影响梯度方向的正确理解**<br/>- 数学中，描述函数时提到的“一维、二维、n维”指的是什么<br/>- 矩阵乘法梯度计算<br/>- BN训练时用的是有偏估计，推理时用的是无偏估计(bessel correction 贝塞尔纠正 (1/(n-1))) <https://mathcenter.oxford.emory.edu/site/math117/besselCorrection/>|
